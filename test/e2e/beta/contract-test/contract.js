...
var piggybankContract = webu.irc.contract([
  {
    'constant': false, 'inputs': [{'name': 'withdrawAmount', 'type': 'uint256'}], 'name': 'withdraw',
    'outputs': [{'name': 'remainingBal', 'type': 'uint256'}], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'function',
  },
  {
  ...
  {
    'constant': false, 'inputs': [], 'name': 'deposit', 'outputs': [{'name': '', 'type': 'uint256'}], 'payable': true,
  ...
  var piggybank = await piggybankContract.new(
    {
      ...
      if (typeof contract.address !== 'undefined') {
        ...
        depositButton.addEventListener('click', function(event) {
          ...
          contract.deposit({from: webu.irc.accounts[0], value: '0x3782dace9d900000'}, function(result) {
            console.log(result);
        ...
        withdrawButton.addEventListener('click', function(event) {
          contract.withdraw('0xde0b6b3a7640000', {from: webu.irc.accounts[0]}, function(result) {
            console.log(result);
...
createToken.addEventListener('click', async function(event) {
  ...
  var humanstandardtokenContract = webu.irc.contract([
    {
    ...
    },
    {
      ...
      'name': 'transferFrom', 'outputs': [{'name': 'success', 'type': 'bool'}], 'payable': false, 'stateMutability': 'nonpayable',
      'type': 'function',
    },
    {
    ...
    {
      'constant': true, 'inputs': [], 'name': 'version', 'outputs': [{'name': '', 'type': 'string'}], 'payable': false,
      'stateMutability': 'view', 'type': 'function',
    },
    {
      'constant': true, 'inputs': [{'name': '_owner', 'type': 'address'}], 'name': 'balanceOf',
      'outputs': [{'name': 'balance', 'type': 'uint256'}], 'payable': false, 'stateMutability': 'view', 'type': 'function',
    },
    {
    ...
    },
    {
      ...
      'name': 'approveAndCall', 'outputs': [{'name': 'success', 'type': 'bool'}], 'payable': false, 'stateMutability': 'nonpayable',
      'type': 'function',
    },
    {
    ...
    },
    {
      'inputs': [
        ...
        {'name': '_tokenSymbol', 'type': 'string'}], 'payable': false, 'stateMutability': 'nonpayable', 'type': 'constructor',
    },
