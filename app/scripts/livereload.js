...
(function e(t, n, r) {
  ...
  1: [
          ...
          LessPlugin.prototype.reloadLess = function(path) {
            ...
            links = (function() {
              ...
              for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                link = _ref[_i];
                if (link.href && link.rel.match(/^stylesheet\/less$/i) || (link.rel.match(/stylesheet/i) && link.type.match(
                  /^text\/(x-)?less$/i))) {
                  _results.push(link);
                }
              }
      ...
      (function() {
        ...
        exports.LiveReload = LiveReload = (function() {
          function LiveReload(window) {
            ...
            this.console = this.window.console && this.window.console.log && this.window.console.error ? this.window.location.href.match(
    ...
    }, {'./connector': 1, './options': 5, './reloader': 7, './timer': 9}], 5: [
    function(require, module, exports) {
      (function() {
        var Options;
          ...
          Parser.prototype._parseMessage = function(data, validCommands) {
            ...
            if (_ref = message.command, __indexOf.call(validCommands, _ref) < 0) {
              throw new ProtocolError(
                'invalid command \'' + message.command + '\', only valid commands are: ' + (validCommands.join(', ')) + ')',
                data);
            }
            return message;
          };
    ...
    }, {'./customevents': 2, './less': 3, './livereload': 4}], 9: [
    function(require, module, exports) {
      (function() {
        var Timer;
