...
class TransactionStateManager extends EventEmitter {
  ...
  getTxList() {
    ...
    return fullTxList.filter((txMeta) => txMeta.irmetaNetworkId === network);
  }
  ...
  wipeTransactions(address) {
    ...
    const otherAccountTxs = txs.filter((txMeta) => !(txMeta.txParams.from === address && txMeta.irmetaNetworkId === network));
