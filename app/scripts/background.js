 ...
 * @property {boolean} isMascara - True if the current context is the extensionless AuraMascara project.
 ...
 * @property {number} conversionRate - A number representing the current exchange rate from the user's preferred currency to Ircer.
