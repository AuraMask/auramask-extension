...
module.exports = function(lostAccounts) {
  return {
    ...
    body: `AuraMask has fixed a bug where some accounts were previously mis-generated. This was a rare issue, but you were affected!
...
We have marked the affected accounts as "Loose", and recommend you transfer ircer and tokens away from those accounts, or export & back them up elsewhere.
...
[1]: https://medium.com/auramask/auramask-3-migration-guide-914b79533cdd#.7d8ktj4h3
    `,
  };
};
