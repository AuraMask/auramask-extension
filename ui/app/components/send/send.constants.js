...
const MIN_GAS_PRICE_GWEI = ircUtil.addHexPrefix(conversionUtil(MIN_GAS_PRICE_HEX, {
...
const NEGATIVE_IRC_ERROR = 'negativeIRC';
const INVALID_RECIPIENT_ADDRESS_ERROR = 'invalidAddressRecipient';
const REQUIRED_ERROR = 'required';

const ONE_GWEI_IN_WEI_HEX = ircUtil.addHexPrefix(conversionUtil('0x1', {
