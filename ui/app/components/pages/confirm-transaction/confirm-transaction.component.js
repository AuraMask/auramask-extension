...
import ConfirmSendIrcer from '../confirm-send-ircer';
    ...
    return id && (!paramsTransactionId || paramsTransactionId === id + '')
      ? (
        <Switch>
          ...
          <Route
            exact
            path={`${CONFIRM_TRANSACTION_ROUTE}/:id?${CONFIRM_SEND_IRCER_PATH}`}
            component={ConfirmSendIrcer}
          />
          <Route
            exact
