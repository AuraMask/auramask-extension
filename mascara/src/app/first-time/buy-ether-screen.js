...
class BuyEtherScreen extends Component {
  ...
  renderCoinbaseForm() {
    ...
    return (
      < div;
    className = 'buy-ether__action-content-wrapper' >
      < div > {this.renderCoinbaseLogo();
  }<
    /div>
    < div;
    className = 'buy-ether__body-text' > Coinbase;
    is;
    the;
    world’s;
    most;
    ...
    litecoin. < /div>
    < a;
    className = 'first-time-flow__link buy-ether__faq-link' > What;
    is;
    Ethereum ?
  <
    /a>
    < div;
    className = 'buy-ether__buttons' >
      < button;
  ...
  renderContent() {
    ...
    switch (this.state.selectedOption) {
      ...
      case OPTION_VALUES.SHAPESHIFT:
        ...
        className = 'buy-ether__action-content-wrapper' >
          < div;
        className = 'shapeshift-logo' / >
          < div;
        className = 'buy-ether__body-text' >
          Trade;
        any;
        leading;
        blockchain;
        asset;
        for any other.Protection
        by;
        Design.No;
        Account;
        Needed.
        < /div>
        < ShapeShiftForm;
        btnClass = 'first-time-flow__button' / >
          < /div>;
      )
    ...
    />
    < div;
    className = 'buy-ether__body-text' > Deposit;
    Ether;
    directly;
    into;
    your;
    account. < /div>
    < div;
    className = 'buy-ether__small-body-text' > (This
    is;
    the;
    account;
    address;
  ...
  render() {
    ...
    />
    < div;
    className = 'buy-ether__title' > Deposit;
    Ether < /div>
    < div;
    className = 'buy-ether__body-text' >
      MetaMask;
    ...
    < /div>
    < div;
    className = 'buy-ether__content-wrapper' >
      < div;
    className = 'buy-ether__content-headline-wrapper' >
      < div;
    className = 'buy-ether__content-headline' > Deposit;
    Options < /div>;
    {this.renderSkip();}
  <
    /div>
    < div;
    className = 'buy-ether__content' >
      < div;
    className = 'buy-ether__side-panel' >
  ...
  <
    div;
    className = 'buy-ether__side-panel-item-name' > {name} < /div>;
    {
      value === selectedOption && (
      < svg;
  ...
  <
    /div>
    < div;
    className = 'buy-ether__action-content' >
      {this.renderContent();
  }
  <
    /div>
