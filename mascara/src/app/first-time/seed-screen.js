...
class BackupPhraseScreen extends Component {
  ...
  exportSeedWords = () => {
    ...
    exportAsFile('IrMeta Secret Backup Phrase', seedWords, 'text/plain');
  };
    ...
    return (
      <div className="backup-phrase__content-wrapper">
        <div className="backup-phrase__phrase">
          ...
          <div className="backup-phrase__body-text">
            WARNING: Never disclose your backup phrase. Anyone with this phrase can take your Ircer forever.
          </div>
        ...
        <div className="backup-phrase__tips">
          ...
          <div className="backup-phrase__tips-text">
            Write this phrase on a piece of paper and store in a secure location. If you want even more security, write it down on multiple
